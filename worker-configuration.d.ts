/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4dff1262ef1253cb914eec48223eff19)
// Runtime types generated with workerd@1.20260831.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	ISSUER: "https://id.entangleit.com";
	NODE_ENV: "production";
	TWETCH_LIVE: "true";
	TWETCH_DEMO_MODE: "false";
	TWETCH_AUTH_URL: "https://api.twetch.com";
	TWETCH_API_URL: "https://api.twetch.com";
	TWETCH_GRAPHQL_URL: "https://api.twetch.com";
	TWETCH_AUTH_FRONTEND_URL: "https://twetch.com";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ISSUER" | "NODE_ENV" | "TWETCH_LIVE" | "TWETCH_DEMO_MODE" | "TWETCH_AUTH_URL" | "TWETCH_API_URL" | "TWETCH_GRAPHQL_URL" | "TWETCH_AUTH_FRONTEND_URL">> {}
}
declare module "*.ejs" {
	const value: string;
